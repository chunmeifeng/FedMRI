...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config", default="different_dataset_different_subsample", help="choose a experiment to do")
